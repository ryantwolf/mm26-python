...
class Strategy:
    ...
    def is_better_item(self, item1, flat_attack_weight, flat_defense_weight, flat_speed_weight, flat_health_weight):
        ...
        if isinstance(item1, Clothes):
            player_flat_attack_change = self.my_player.get_.get_stats().get_flat_attack_change() * flat_attack_weight
            player_flat_defense_change = self.my_player.get_.get_stats().get_flat_defense_change() * flat_defense_weight
            player_flat_speed_change = self.my_player.get_.get_stats().get_flat_speed_change() * flat_speed_weight
            player_flat_health_change = self.my_player.get_.get_stats().get_flat_health_change() * flat_health_weight
